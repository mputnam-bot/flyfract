...
void main() {
    ...
    // Celtic fractal iteration
    // Like Mandelbrot but with: real(z^2) = |x^2 - y^2| (absolute value)
    // z_new = (|x^2 - y^2| + c_x, 2xy + c_y)
    vec2 z = vec2(0.0);
    int iter = 0;
    ...
    for (int i = 0; i < 2000; i++) {
        ...
        // Celtic variant: take absolute value of real part of z^2
        float newX = abs(zx2 - zy2) + c.x;
        float newY = 2.0 * z.x * z.y + c.y;
